...
\thanks{The authors are with the College of Engineering, University of California, Riverside, CA, USA.  The corresponding author is H. Mohsenian-Rad, e-mail: hamed@ece.ucr.edu.} \vspace{-0.5cm}}
...
\centering
\vspace{-0.2cm}
{\scalebox{.5}{\includegraphics*{figs/TestVoltagesV4.eps}}} \vspace{-0.2cm}
...
The test included operating the BESS over a full cycle, by charging and discharging at a constant 1 A current.  %\ref{fig:initial_soc}(a).
...
We operate the BESS in six  test cases, where the same number of weak cells are affecting  one  or more of the battery strings. % ed varying number of the battery strings.
